...
<html lang="en">
  ...
  <body data-spy="scroll" data-offset="0" data-target="#navbar-main">
      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li> <a href="#curriculm" class="smoothScroll"> Curriculm</a></li>
            <li> <a href="#team" class="smoothScroll"> Team</a></li>
            <li> <a href="#blog" class="smoothScroll"> Blog</a></li>
            <li> <a href="#contact" class="smoothScroll"> Contact</a></li>
            <li><a class="icon icon-twitter" href="https://twitter.com/atsuki03" target="_blank"></a></li>
            <li><a class="icon icon-facebook" href="https://www.facebook.com/atsuki.wada" target="_blank"></a></li>
        </div><!--/.nav-collapse -->
      </div>
    </div>
    </div>
    ...
    <div class="container" id="services" name="services">
      <div class="row white">
      <br>
        <h1 class="centered">Why We Do</h1>
        <hr>
        ...
        <div class="servicePhoto">
          <img src="assets/img/services/why.jpg" align="right">
        </div><!-- col-lg-6 -->
      </div><!-- row -->
    </div><!-- container -->
    ...
    <div class="container" id="services" name="services">
      <div class="row white">
      <br>
        <h1 class="centered">How We Do</h1>
        <hr>
        
        <div class="servicePhoto">
          <img src="assets/img/services/why.jpg" align="left">
        </div><!-- col-lg-6 -->
        <div class="col-lg-6">
          <p>We believe ideas come from everyone, everywhere. In fact, at BlackTie, everyone within our agency walls is a designer in their own right. And there are a few principles we believe—and we believe everyone should believe—about our design craft. These truths drive us, motivate us, and ultimately help us redefine the power of design. We’re big believers in doing right by our neighbors. After all, we grew up in the Twin Cities and we believe this place has much to offer. So we do what we can to support the community we love.</p>
        </div><!-- col-lg-6 -->
    ...
    <div class="container" id="services" name="services">
      <div class="row white">
      <br>
        <h1 class="centered">What We Do</h1>
        <hr>
    ...
    <!-- ==== CURRICULM ==== -->
  <div id="greywrap">
    <div class="container" id="curriculm" name="curriculm">
    <br>
      <br>
      <div class="row">
        <h2 class="centered">カリキュラム</h2>
        <hr>
        <br>
          <table rules="all">
            <tbody>
    ...
    <section class="section-divider textdivider divider6">
      <div class="container">
        <h1>社名 IN NARA, JAPAN.</h1>
        <hr>
        <p>奈良県奈良市</p>
        <p>0745 xx xxxx</p>
        <p><a class="icon icon-twitter" href="https://twitter.com/atsuki03" target="_blank"></a> | <a class="icon icon-facebook" href="https://www.facebook.com/atsuki.wada" target="_blank"></a></p>
      </div><!-- container -->
    </section><!-- section -->
    ...
    <div class="container" id="contact" name="contact">
      ...
      <br>
        ...
        <div class="col-lg-4">
          ...
          <p><span class="icon icon-home"></span> 奈良県奈良市<br/>
            <span class="icon icon-phone"></span> 0745-xx-xxxx <br/>
            <span class="icon icon-mobile"></span> 090-xxxx-xxxx <br/>
            <span class="icon icon-envelop"></span> <a href="mailto:gnawedapple.macapple@gmail.com?subject=問い合わせ&amp;body=ご記入ください" target=”_blank”>gnawedapple.macapple@gmail.com</a><br/>
            <span class="icon icon-twitter"></span> <a href="https://twitter.com/atsuki03" target=”_blank”> @社名 </a> <br/>
            <span class="icon icon-facebook"></span> <a href="https://www.facebook.com/atsuki.wada" target=”_blank”> 社名 </a> <br/>
          </p>
        </div><!-- col -->
